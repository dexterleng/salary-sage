    ...
    <div className="flex flex-col items-center justify-center gap-4">
      {isRecording ? (
        <div className="flex flex-col items-center justify-center">
          <Button
            variant="destructive"
            className="group bg-destructive/30 hover:bg-destructive/50 rounded-full w-24 h-24"
          ...
          <TypographyBody className="mt-4 text-center">
            {getTime(audioLength)}
          </TypographyBody>
        </div>
      ) : (
        <div className="flex flex-col items-center justify-center">
          <Button
            variant="secondary"
            className="group rounded-full w-24 h-24"
            disabled={isDisabled}
            onClick={handleRecordToggle}
          >
