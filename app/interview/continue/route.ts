...
/**
 * Given an interviewId and a user's response, gets the AI's next response in the interview.
 * 
...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `You have been provided with the transcript of a negotiation. You are the interviewer.
