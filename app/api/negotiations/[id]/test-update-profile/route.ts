...
export async function POST(
  ...
  { params }: { params: { id: string } }
    ...
    try {
        ...
        // // const uncleanedResumeText: string = await extractTextFromPDFFile(resumeFile!)
        const parsedPdf = await readPdf(arrayBuffer)

        console.log(resumeParsed)

        return NextResponse.json({resumeParsed}, { status: 200 });
    } catch (error: any) {
...
//   }
  ...
  export const readPdf = async (file: ArrayBuffer) => {
